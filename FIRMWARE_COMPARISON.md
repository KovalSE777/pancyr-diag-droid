...
#### 4. Конфигурация систем SKA/SKE

**Прошивка (строки 1784-1785, 1860):**
```c
if(bBL_2){if(n_V_cnd<2)f_ok_cnd=0;}  // bBL_2=1 => SKE => 2 вентилятора
else {if(n_V_cnd<3)f_ok_cnd=0;}      // bBL_2=0 => SKA => 3 вентилятора

if(!bBL_2)uUP_M3=1; // Аппарат (SKA): 3 вентилятора (M1,M2,M3)
```

**Наше приложение:**
```typescript
// SKA: 3 вентилятора конденсатора ✅
// SKE: 2 вентилятора конденсатора ✅
kUM1_cnd: isSKE ? 2 : 3
```
...
| SKA/SKE конфигурация | bBL_2 (0=SKA, 1=SKE) | ✓ | ✅ |
| Количество вентиляторов | SKA=3, SKE=2 | ✓ | ✅ |
